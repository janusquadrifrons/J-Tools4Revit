...
namespace J_Tools
{
    ...
    class Command8_J_SelDel_Pt : IExternalCommand
    {
            ...
            try
            {
                ...
                var references = uidoc.Selection.PickObjects(
                    ObjectType.Element, new ElementsSelectionFilter(
                        e => e is Point)); // --- via this Lambda expression will allow selectiong objects that only ones classified at ElementSelectionFilter
