...
namespace J_Tools
{
    class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication a)
        {
            ...
            // --- create buttons
            var button1 = new PushButtonData("J Tools button1", "J_Trim", Assembly.GetExecutingAssembly().Location, "J_Tools.Command1");
            ...
            var button3 = new PushButtonData("J Tools button3", "SelectSimilar", Assembly.GetExecutingAssembly().Location, "J_Tools.Command3");
            button3.ToolTip = "Sibling Selector";
            button3.LongDescription = "Select similar entities with similar styles as in AutoCad...";

            var button4 = new PushButtonData("J Tools button4", "Parameters", Assembly.GetExecutingAssembly().Location, "J_Tools.Command4");
            button4.ToolTip = "ooo";
            button4.LongDescription = "xxx";

            var button6 = new PushButtonData("J Tools button6", "QSelect", Assembly.GetExecutingAssembly().Location, "J_Tools.Command6");
            button6.ToolTip = "ooo";
            ...
            IList<RibbonItem> stackedButtons = panel.AddStackedItems(button2, button3, button6);
